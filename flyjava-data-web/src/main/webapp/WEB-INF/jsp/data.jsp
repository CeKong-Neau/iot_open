...
<body class="fixed-sidebar">
    ...
    <div class="row  border-bottom white-bg dashboard-header">
    	<div class="btn-group-justified">
	    	...
	    	<div class="col-sm-4 btn-group">
	    		<a type="button" class="btn btn-primary" style="height:50px">
		    		<div class="container-fluid">
			          		<div class="row">
			          			...
			          			<div class="col-sm-4">
			          				 <i class="fa fa-tint fa-3x" style="margin-bottom:5px" aria-hidden="true"></i> 
			          			</div>
			          		</div>
			        </div>
	    		 </a>
	    	...
	    	<div class="col-sm-4 btn-group">
	    		<a type="button" class="btn btn-info" style="height:50px"> 
					<div class="container-fluid">
			          		<div class="row">
			          			<div class="col-sm-8">
			          				<h4>0.00mm</h4>
	    	...
	    	<div class="col-sm-4 btn-group">
	    		<a type="button" class="btn btn-warning" style="height:50px">
					<div class="container-fluid">
			          		<div class="row">
			          			<div class="col-sm-8">
			          				<h4>工作中</h4>
    	 ...
    	 <!--日期搜索  -->
    	<from class="form-inline" style="margin-left:14px;">
	    	<div class="form-group" >
	    		<div class="input-group form_datetime">
	    			<span class="input-group-addon">开始时间</span>
	    	 		<input size="10" type="text" id="datetimeStart" readonly class="form-control" autocomplete="off">
	    	 		<span class="input-group-addon"><span class="glyphicon glyphicon-remove remove-start"></span></span>
	    	 	</div>
	    	 	<div class="input-group form_datetime">
	    	 		<span class="input-group-addon">结束时间</span>
					<input size="10" type="text" id="datetimeEnd" readonly class="form-control" autocomplete="off">
	    	 		<span class="input-group-addon"><span class="glyphicon glyphicon-remove remove-end"></span></span>
	    	 	</div>
	    	</div>
	    	
			<button type="button" id="searchButton" class="btn btn-primary" onclick="SEARCH.search();">时间查询</button>
 	    </from>
    	<div class="hr-line-dashed"></div>
    	 
	     <div class="col-sm-12">
	     	 <h5 class="text-info text-center">设备ID :${productId}</h5>
	     	<!-- 图表占位容器 -->
   ...
   <!--  <script src="/js/demo/sparkline-demo.js" ></script> -->
	...
	<script type="text/javascript">
		...
		/*异步刷新折线图*/
       var myTimer= setInterval('reloadChart()',5000); //每5秒刷新一次页面下边显示的数据
       myChart.showLoading();    //数据加载完之前先显示一段简单的loading动画
       function reloadChart(){
       $.ajax({
           url:'<%=DATA_URL%>/data/showTemp',
           type:'POST',
	...
	var SEARCH={
		...
		doSubmit:function(){
			...
			$.ajax({
				type : "POST",
				url : SEARCH.param.surl + "/data/searchTemp?r=" + Math.random(),
				data : {"productId":productId,"start":start,"end":end},
	           async:false,    //或false,是否异步
	           datatype: "json",
	           success:function(data){
	           				  myChart.hideLoading();    //隐藏加载动画
